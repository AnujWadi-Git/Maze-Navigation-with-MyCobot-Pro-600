...
input_csv = "E:/ras/project/project/TEST_files/Final_files/output_coordinates/physical_coordinates.csv"  # Replace with the path to your CSV file
poses_df = pd.read_csv(input_csv)

# Convert the DataFrame to a Python list
target_pose = poses_df[['PhysicalX', 'PhysicalY', 'PhysicalZ']].values.tolist()
